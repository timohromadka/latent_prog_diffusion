...
class VQVAE(nn.Module):
    def __init__(self, args):
        ...
        self.num_downsampling_layers = args.num_downsampling_layers
        self.num_residual_layers = args.num_residual_layers
        self.num_residual_hiddens = args.num_residual_hiddens
        ...
        self.pre_vq_conv = nn.Conv2d(
            in_channels=self.num_hiddens, out_channels=self.embedding_dim, kernel_size=1
        )
        self.vq = VectorQuantizer(
            self.embedding_dim, self.num_embeddings, self.use_ema, self.decay, self.epsilon
        )
